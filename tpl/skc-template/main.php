...
<body class="user-<?php echo $INFO["userinfo"]["name"] ?>">
    ...
    <div id="dokuwiki__site abc"><div id="dokuwiki__top" class="site abc <?php echo tpl_classes(); echo $whatINeed; ?> <?php
        ...
        <div id="dokuwiki__header"><div class="pad">
            ...
            <div class="headings">
                    <a href="/<?php echo $conf['start'] ?>"><figure class="skc-logo"><?php skc_tpl_render_logo(tpl_getConf('skc-logo')) ?></figure></a>
                <?php if(tpl_getConf('skc-logo-hide-h1')): ?>
            ...
            <div class="tools">
                <!-- USER TOOLS -->
                <?php if ($INFO['userinfo'] != NULL && $conf['useacl'] && $showTools): ?>
